      ...
      <div className="relative z-10 max-w-5xl mx-auto">
          <div className="inline-block px-6 py-2.5 bg-gradient-to-r from-red-500/20 to-orange-500/20 backdrop-blur-sm border border-red-500/40 rounded-full mb-6 shadow-lg shadow-red-500/30 hover:shadow-red-500/50 transition-all duration-300 hover:scale-105 animate-in fade-in slide-in-from-top duration-700 animate-pulse">
            <span className="text-red-400 font-bold text-sm flex items-center gap-2">
              ...
              Black Friday: Até 35% OFF - Últimas Vagas de Novembro!
              <span className="text-lg">🔥</span>
            </span>
          </div>                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 leading-tight animate-in fade-in slide-in-from-bottom duration-700 delay-100">
            Transforme Sua Presença Digital com{" "}
            <span className="bg-gradient-to-r from-emerald-400 via-emerald-500 to-emerald-600 bg-clip-text text-transparent animate-gradient bg-[length:200%_auto] relative">
              ...
              <span className="relative">Sites que Convertem</span>
                  ...
                  <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom duration-700 delay-200">
            Crie um <span className="text-white font-bold">site profissional que gera vendas</span> sem gastar uma fortuna.
            <br />
            <span className="text-emerald-400 font-semibold">✅ Entrega em 7 dias • ✅ 4 revisões grátis • ✅ Pagamento único</span>
          </p>
          <div className="flex items-center justify-center gap-2 mb-6 text-slate-400 text-sm animate-in fade-in duration-700 delay-300">
            <div className="flex -space-x-2">
              <div className="w-8 h-8 rounded-full bg-emerald-500 border-2 border-slate-900 flex items-center justify-center text-white text-xs font-bold">JS</div>
              <div className="w-8 h-8 rounded-full bg-emerald-600 border-2 border-slate-900 flex items-center justify-center text-white text-xs font-bold">MC</div>
              <div className="w-8 h-8 rounded-full bg-emerald-400 border-2 border-slate-900 flex items-center justify-center text-white text-xs font-bold">LF</div>
            </div>
            <span className="text-emerald-400 font-semibold">+15 clientes satisfeitos este mês</span>
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4 w-full sm:w-auto">
          <button 
            ...
            className="group/cta relative w-full sm:w-auto px-10 py-5 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-white font-bold rounded-2xl text-base sm:text-lg transition-all duration-300 hover:scale-105 text-center shadow-2xl shadow-emerald-500/40 hover:shadow-emerald-500/60 overflow-hidden"
          >
          ...
          <a 
            ...
            className="group/whats relative w-full sm:w-auto px-8 py-4 bg-slate-800/70 backdrop-blur-sm text-white font-semibold rounded-xl text-sm sm:text-base border-2 border-slate-600/50 hover:border-emerald-500/70 hover:bg-slate-800/90 transition-all duration-300 hover:scale-105 text-center"
          >
            <span className="relative flex items-center justify-center gap-2">
              ...
              Tirar Dúvidas (Resposta Rápida)
            </span>
          </a>
        </div>
        <p className="mt-4 text-slate-500 text-sm text-center animate-in fade-in duration-700 delay-400">🔒 Sem compromisso • ⚡ Atendimento em minutos</p>

        {/* Trust indicators */}
        <div className="mt-10 sm:mt-14 grid grid-cols-3 gap-4 sm:gap-6 max-w-3xl mx-auto px-4 animate-in fade-in slide-in-from-bottom duration-700 delay-500">
