        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base">
              <li><a href="#servicos" onClick={(e) => { e.preventDefault(); handleLinkClick('#servicos'); }} className="text-slate-400 hover:text-emerald-500 transition-colors cursor-pointer">Serviços</a></li>
              <li><a href="#portfolio" onClick={(e) => { e.preventDefault(); handleLinkClick('#portfolio'); }} className="text-slate-400 hover:text-emerald-500 transition-colors cursor-pointer">Portfólio</a></li>
              <li><button onClick={() => { if (setCurrentPage) setCurrentPage('planos'); }} className="text-slate-400 hover:text-emerald-500 transition-colors cursor-pointer">Planos</button></li>
              <li><a href="#contato" onClick={(e) => { e.preventDefault(); handleLinkClick('#contato'); }} className="text-slate-400 hover:text-emerald-500 transition-colors cursor-pointer">Contato</a></li>
            </ul>
          </div>
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-2 text-slate-400 text-sm sm:text-base">
              <li className="flex items-center">
                ...
                <a href="https://wa.me/5511952445898" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 transition-colors">(11) 95244-5898</a>
              </li>
              <li className="flex items-start">
                ...
                <a href="mailto:jvs.devsilva@gmail.com" className="hover:text-emerald-500 transition-colors break-all">jvs.devsilva@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
