  ...
  return (
    <section id="contato" className="py-12 sm:py-16 bg-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
                <div className="max-w-2xl mx-auto bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 sm:p-8 hover:border-emerald-500/50 hover:bg-slate-800/80 transition-all duration-500 shadow-2xl hover:shadow-emerald-500/10">
          <div className="text-center space-y-6">
            <div className="inline-block px-3 sm:px-5 py-1.5 sm:py-2 bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-500/40 rounded-full mb-4 animate-pulse">
              <span className="text-red-400 font-bold text-xs sm:text-sm flex items-center gap-1.5">
                <span className="hidden xs:inline">🔥</span>
                <span className="hidden sm:inline">Últimas vagas de Novembro com 35% OFF</span>
                <span className="sm:hidden">35% OFF - Últimas Vagas!</span>
                <span className="hidden xs:inline">🔥</span>
              </span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6 max-w-lg mx-auto">
              ...
              className="group/whats inline-flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-white font-bold py-4 sm:py-5 px-6 sm:px-10 rounded-2xl transition-all duration-300 text-sm sm:text-base md:text-lg shadow-2xl shadow-emerald-500/40 hover:shadow-emerald-500/60 hover:scale-105 relative overflow-hidden w-full sm:w-auto justify-center"
            >
              ...
              <svg className="w-5 h-5 sm:w-6 sm:h-6 relative z-10 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="relative z-10">
                <span className="hidden sm:inline">Começar Agora - 35% OFF</span>
                <span className="sm:hidden">Garantir 35% OFF</span>
              </span>
            </a>
            <p className="text-xs sm:text-sm text-slate-500 mt-3 text-center">💬 Resposta média em 5 minutos • Online agora</p>
